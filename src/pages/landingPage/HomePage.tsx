        ...
        >
          <Box position="relative" w="100%" h="100%">
            <video
              ...
              loop
              muted
              style={{ opacity: ".5", objectFit: "cover" }}
              playsInline
            >
            ...
            >
              ...
              >
                {" "}
                Discover extraordinary fashion with unique, trend-defying
                designs for those who love to stand out.{" "}
              </Text>
              <Button
                color="white"
                bg="transparent"
        ...
        <Flex direction="column" w="100%" position="relative">
          ...
          >
            ...
            >
              ...
              occasion. Experience the perfect blend of affordability and
          ...
          >
            ...
            <Button
              ...
              rounded="16px"
              colorScheme="teal"
              rightIcon={<MdOutlineShoppingBag />}
            >
              {" "}
              Browse Collections{" "}
            </Button>
